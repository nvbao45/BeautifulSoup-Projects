...
old_csv_file = "220505 - OpenVC.csv"
new_csv_file = "220505 - OpenVC-linkedin.csv"
base_url = "https://www.openvc.app/fund/"

csvfile = open(old_csv_file, encoding='utf-8')
csvreader = csv.reader(csvfile)

header = ["Investor name","Website","Linkedin","Global HQ","Countries of investment","Stage of investment","Investment thesis","Investor type","First cheque minimum","First cheque maximum"]
